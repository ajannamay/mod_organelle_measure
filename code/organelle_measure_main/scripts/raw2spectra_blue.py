...
df_meta.to_csv(f"{var.path_out}/{current_folder}/spectra/blue_meta_normalized.csv",index=False)
...
##
df_meta = pd.read_csv(f"{var.path_out}/{current_folder}/spectra/blue_meta_normalized.csv")
list_df = []
...
df_img.to_csv(f"{var.path_out}/{current_folder}/spectra/blue_spectra_images.csv",index=False)


# Plot spectra:

df_img = pd.read_csv(f"{var.path_out}/{current_folder}/spectra/blue_spectra_images.csv")
...
for color in ['blue']:
    ...
    fig.write_html(f"{var.path_out}/{current_folder}/spectra/blue_white_unmix_comparison_{color}.html")