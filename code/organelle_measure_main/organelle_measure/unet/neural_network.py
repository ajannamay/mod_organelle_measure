...
def prediction(im, mic_type, pretrained_weights=None, model_type='pytorch', device=None):
    ...
    if pretrained_weights is None:
        if mic_type == 'pc':
            pretrained_weights = str(path_weights) + '/' + 'unet_weights_batchsize_25_Nepochs_100_SJR0_10'
    ...
    if model_type == 'tensorflow':
        ...
        print('============================')
        print('============================')
        print('model pytorch using')
        print('model pretrained_weights using::',pretrained_weights)
